...
import {
  ...
  Settings, LogOut, Menu, Sun, Moon, Bell, Search, BarChart2, Star, Wallet, ShieldBan,
} from 'lucide-react';
...
const MAIN_NAV = [
  ...
  { label: 'Blacklist', href: '/admin/blacklist', Icon: ShieldBan,    exact: false, badgeKey: null      },
];
